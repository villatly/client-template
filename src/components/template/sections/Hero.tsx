  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center text-white">
        ...
        <p className="mx-auto mb-10 max-w-2xl text-xs sm:text-sm font-medium uppercase tracking-[0.2em] text-white/80 leading-loose text-justify [text-align-last:center]">
          {content.intro}
        </p>
